...
const Navigation = ({
  ...
  const headerSurfaceClasses = 'border-b border-[rgba(242,194,58,0.16)] bg-[rgba(26,16,37,0.92)] shadow-[0_10px_32px_rgba(0,0,0,0.35)] backdrop-blur-[10px]';
  ...
  const handleLogoClick = (e) => {
    ...
    if (setShowShopSubmenu) setShowShopSubmenu(false);
    if (setShowShopDropdown) setShowShopDropdown(false);
    if (setShowSearchDropdown) setShowSearchDropdown(false);
  ...
  return (
    <>
      ...
      <header
        className={`main-header ${isScrolled ? 'scrolled' : ''} ${headerSurfaceClasses} transition-[background-color,box-shadow,backdrop-filter,border-color] duration-300`}
        style={{
          position: 'fixed',
          top: 0,
          left: 0,
      ...
      >
        <div className="content-width main-header-inner">
          <a
            href="/"
            className="logo-area cursor-pointer no-underline rounded-[10px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-[rgba(242,194,58,0.9)]"
      ...
      {menuOpen ? (
        ...
        >
          ...
          >
            ...
            <div style={{ position: 'relative', paddingBottom: "12px", marginBottom: "16px", paddingTop: '0' }}>
              <a
                href="/"
                className="logo-area cursor-pointer no-underline rounded-[10px]"
                onClick={handleLogoClick}
                style={{ display: 'flex', alignItems: 'center', gap: '12px', paddingLeft: '16px', textDecoration: 'none' }}
                aria-label="Go to home page"
              >
                <img src="/logo.jpg.jpeg" alt="Rajasekhar Art Jewellery Logo" className="logo-icon" style={{ objectFit: 'cover', padding: 0 }} />
                <div className="logo-text">
